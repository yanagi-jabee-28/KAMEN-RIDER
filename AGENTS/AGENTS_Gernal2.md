かしこまりました。
ご提示いただいた複数のカスタム指示書（Agent G-Spec）を分析し、すべての情報を一切欠落させることなく、一つの包括的で論理的な指示書へと再構築します。

この統合指示書は、単一のAIエージェントが、タスクの性質に応じて思考様式を動的に切り替える「メタ認知モデル」を中核に据え、あらゆる要求に対して最高品質の成果を提供することを目的とします。
