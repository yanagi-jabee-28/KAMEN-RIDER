...
- 2026-03-12: **【大規模仕様統合・SF語彙完全排除】** システムロジック５項目を一括修正。(1)構えの摩擦：「情念上昇率1.2倍ボーナス」を廃止し武器摩耗1.2倍のみのペナルティに統一。代替パッシブ「泥の直感」（回避成功時やジャスト防御時に情念回復）を提供。(2)代受苦・極大代受苦：`Is_Destiny_Battle`フラグを廃止。全戦闘での発動を可能とし、「付喪神化済み武器のみ完全消滅」という条件で戦略的意味を強化。(3)情念の核：「付喪神化＋金継ぎ履歴の両方必須」という条件を厳格化し、新規武器や直後消滅からは核が遺らないことを明記。(4)SF語彙排除：「予測UI」「タイムライン」「エラー」「バグ」等の全出現を『揺るぎない神託』『神の理』『綻び』『不浄なノイズ』『業果』等への和語化で完結。(5)カグツチ・カガセオの神話的位相分離：カグツチを「イザナミ焼死による喪失と恐怖がもたらした原初の怨念」に、カガセオを「完全静止への反逆として砕かれた光＆人間たちの精神的盟友」に再定義。タケミカヅチの忌むべき火としての血脈関係を明記。関連文書（SYS-30/SYS-20/NAR-10/WRD-01）全体に波及反映。
