...
| ID | 移植元 | 移植先 | 内容 | 優先度 | 重複対策 | 検証 | Status |
|---|---|---|---|---|---|---|---|
| S-01 | RPG5 SYS-20 敵系統 | SYS-21 | 敵属性/領域詳細の完全移植 | High | SYS-21正本化 | SYS-20重複ゼロ | Not Started |
| S-02 | RPG5 SYS-20 スキル群 | SYS-30 | 技名/効果/条件の完全実装表 | Critical | SYS-30正本化 | 値漏れ監査 | In Progress |
| S-03 | RPG5 SYS-20 初心者導線 | SYS-22 | 3-5技制限内で判断導線最適化 | High | SYS-22は要約のみ | 仕様値混入ゼロ | In Progress |
| S-04 | RPG5 SYS-30 | SYS-30 | フラグ・コスト・副作用列の完全化 | Critical | SYS-30のみで管理 | フラグ突合 | Not Started |
