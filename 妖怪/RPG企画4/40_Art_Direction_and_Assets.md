...
- **美しい呪いの具現:** 結和神化が覚醒する瞬間、金継ぎの線が脈打ち赤く輝き、武器自身の「意志」が発動して神の完璧な見切りを裏切る。武器に宿った付喪神の力を視覚化するこの動的エフェクトは、戦闘中のカタルシスを高めるための必須要素である。
...
- `Lv2`: 鍛造音・火花・煤の演出を強化。結和神化時は武器に金継ぎ脈動エフェクトが同期する。
