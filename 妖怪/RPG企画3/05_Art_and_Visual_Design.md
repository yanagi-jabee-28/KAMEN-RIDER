...
- **白磁塔／地下楔の対比:** ツクヨミ戦の主要環境として登場する「白磁の塔」は、上昇する天空要素と地下深淵に突き刺さる楔を同一構造に持つ。塔は滑らかな白磁と金継ぎ光線で表現し、その内部や基部に広がる泥濘には和紙と岩絵具の滲みを用いて質感差を際立たせる。このビジュアルコントラストは物語構造の「登る→落ちる」というジェットコースター的時系列を視覚的にも補強する。
