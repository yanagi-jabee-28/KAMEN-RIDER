...
- **徹底事項:**
  ...
  - **黄泉戸喫UIの美術:** 黄泉戸喫状態を示すHPゲージは、和紙に黒墨が染み込み、金継ぎの輝きが走る独特のグラフィックとする。回復時の痛み演出としてゲージが赤黒いノイズを放つアニメーションも規定する。
...
三貴子（アマテラス・ツクヨミ・スサノオ）と、反逆の星神カガセオに関しては、**同じ世界観上にありながら方向性の異なる秩序と反逆**を描く。以下のデザイン指針は互いの対比と物語的意味を強める。
