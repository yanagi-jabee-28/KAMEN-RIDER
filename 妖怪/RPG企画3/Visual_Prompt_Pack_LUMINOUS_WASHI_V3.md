...
details: enveloped in intricate multi-layered white ceremonial robes (Kariginu/Heian style) that read like frozen lily petals rather than a heavy sphere, keeping a slender and majestic silhouette with hidden hands. Her body proportions should remain natural and human‑like—comparable in head‑to‑body ratio to the other high deities described elsewhere—avoiding caricatured elongation. The top layer of cloth should naturally drape over her head like a veil, falling gracefully yet thinly so the head ornament remains completely visible and unobstructed. Somewhere deep within the stacked folds, allow a single layer of crimson cloth to slip free, visible only in glimpses as a red lining or sash winding through the white, reinforcing the sun‑goddess association without dominating the scheme. On her head, add an austere yet unmistakably Amaterasu-style ornament: a simple lacquered hairpin or crown shaped like a stylized rising sun braid, perhaps with a tiny cracked gold ring or shard motif, positioned high on the forehead to invoke ancient imperial regalia without becoming gaudy. Avoid any clichéd “cartoon sun” imagery; the solar references must feel ancient and ceremonial, not decorative cliché. Along the hems and inner folds, incorporate only the faintest hints of solar vermilion or burnt-orange—ancient, almost weathered red brush strokes that suggest ritual dye rather than depict any literal object. Keep the palette minimal; avoid drawing any circles with spikes or sun icons on the cloth. Ensure all fabric appears impeccably clean and smooth, without fraying or fuzz; the robes should look pristine and serene rather than rough or worn. Her expression is beautiful but frozen in eternal, fragile fear, eyes closed or gazing blankly. Build the silhouette as an annular-eclipse motif: the cocooned core is obscured while a sharp, opulent muted-gold corona radiates from the outer ring. The surrounding space should remain **light and luminous**—a pale shrine-like atmosphere with gold dust and washed-out ink, never deep black, avoiding any heavy darkness. Pigments and lines may be bleached toward near-white to convey a sun that freezes rather than warms, but the backdrop must not become a solid black disc.

Negative Prompt:
oil painting, thick impasto, ugly, horror, flat cel-shading, chubby proportions, bulky cocoon mass, bright pop colors, plastic sheen, seamless synthetic surfaces, modern elements, high contrast shadows, hard 3D render look, avoid any depiction of spiky circles or sun icons drawn on her robes
Params:
