...
**STRICT SCARF LOGIC (POST-RITUAL VARIANT):** The white hair remains unchanged, but the **SINGLE SCARF** has lost its bright vivid red heat. It is now a **dull, blackened dried-blood red (dark muddy reddish-black)** representing the passion transferred to the mirror. THIS DULL RED IS EXCLUSIVE TO THIS SCARF. The scarf is wrapped securely. **ONLY ONE SINGLE TAIL trails behind.** The front is tucked. **THERE IS EXACTLY ONE VISIBLE END.** **NO front drape, NO second tail, NO branching, NO bifurcation, NO splitting.** **SYNCHRONIZED WIND LOGIC: The white bob hair and the single scarf tail MUST flutter dynamically in the EXACT SAME DIRECTION.**
...
masterpiece, highest quality, strikingly beautiful, ethereal, and coldly arrogant youthful male archer, Wakahiko, standing in profile in a sharp **Kyudo "Kihon Shisei" side-aiming posture**.
...
details:
[CHARACTER & POSTURE] **KYUDO FUNDAMENTAL POSTURE:** His stance is defined by the "Standing Posture" (立位). The nape of his neck is stretched straight (项を真っすぐに伸ばす), his shoulders are relaxed and dropped, and through the midline of his body, his ears are perfectly aligned over his shoulders (耳たぶが両肩に落ちる). His weight is centered slightly forward on the arches of his feet, suggesting a grounded yet poised readiness. His gaze is precise and cold, looking through the tip of his nose towards a point approximately 4 meters away. His skin is unnervingly perfect, rendered with pale gofun pigments that reveal the raw paper tooth but contain absolutely no human warmth or blemishes. His hair is beautifully short, sleek and silvered. He wears noble Heian-period inspired divine robes (Kariginu) in luminous pearl-white and pale gold.
[EQUIPMENT — Full Draw (Kai)] He is frozen in a **perfectly expanded full draw (Kai)**. The posture emphasizes "standing with the waist" (腰で立つ), showcasing a vertical expansion that feels both static and explosive. He holds his **massive asymmetrical white-lacquered longbow (Ame-no-Makakumi)**, which MUST match the uploaded reference exactly: a single, elegant curve with thin gold leaf seams. **CRITICAL ASYMMETRY: As a traditional Japanese bow (Wa-kyu), it is vertically asymmetrical; the upper limb (above the grip) is significantly longer than the lower limb.** A **taut, straight white silk bowstring** connects the tips. On his back or hip is the **elegant wood and leather quiver (Yugi)** from the reference, containing arrows with sharp blood-red fletching. A sharp accent of blood-red appears on his arrow fletchings.
...
mood: The suffocating, perfect stillness of divine logic and impeccable martial form.
...
# PROMPT
Prompt:
OPERATIONAL INSTRUCTION (NANOBANANA): Use exactly ONE uploaded reference image: the Beat Gauntlet. Integrate the gauntlet seamlessly onto his left arm during generation. **CRITICAL FIT INSTRUCTION: The gauntlet MUST be appropriately sized and re-proportioned to fit his broad, muscular left arm. It must NOT appear delicately sized.**
